      ...
      <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] gap-5">
        <form onSubmit={handleSubmit} className="rounded-[24px] border border-white/10 bg-white/5 p-5 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="bill-name" className="block text-sm font-medium text-slate-200">
                Bill name <span className="text-red-500 ml-1" aria-hidden="true">*</span>
              </label>
            ...
            <div>
              <label htmlFor="bill-due-day" className="block text-sm font-medium text-slate-200">
                Due day <span className="text-red-500 ml-1" aria-hidden="true">*</span>
              </label>
            ...
            <label htmlFor="bill-autopay" className="flex items-center gap-2 text-sm text-slate-200 mt-6 cursor-pointer">
