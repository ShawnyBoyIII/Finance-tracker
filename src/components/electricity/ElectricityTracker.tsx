      ...
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
        ...
        <div className="space-y-5">
          ...
          <form onSubmit={handleManualHistorySubmit} className="cockpit-panel rounded-[28px] p-6 space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label htmlFor="manual-history-provider" className="block text-sm font-medium text-slate-200">Provider</label>
                <input id="manual-history-provider" value={manualHistoryProvider} onChange={(event) => setManualHistoryProvider(event.target.value)} placeholder="Jackson EMC" className={COMMON_INPUT_CLASS} />
              </div>
              <div>
                <label htmlFor="manual-history-account-number" className="block text-sm font-medium text-slate-200">Account label / number</label>
                <input id="manual-history-account-number" value={manualHistoryAccountNumber} onChange={(event) => setManualHistoryAccountNumber(event.target.value)} placeholder="123456789" className={COMMON_INPUT_CLASS} />
              </div>
              <div>
                <label htmlFor="manual-history-bill-date" className="block text-sm font-medium text-slate-200">Bill date</label>
                <input id="manual-history-bill-date" type="date" value={manualHistoryBillDate} onChange={(event) => setManualHistoryBillDate(event.target.value)} className={COMMON_INPUT_CLASS} />
              </div>
              <div>
                <label htmlFor="manual-history-due-date" className="block text-sm font-medium text-slate-200">Due date</label>
                <input id="manual-history-due-date" type="date" value={manualHistoryDueDate} onChange={(event) => setManualHistoryDueDate(event.target.value)} className={COMMON_INPUT_CLASS} />
              </div>
              <div>
                <label htmlFor="manual-history-service-start" className="block text-sm font-medium text-slate-200">Service start</label>
                <input id="manual-history-service-start" type="date" value={manualHistoryServiceStart} onChange={(event) => setManualHistoryServiceStart(event.target.value)} className={COMMON_INPUT_CLASS} />
              </div>
              <div>
                <label htmlFor="manual-history-service-end" className="block text-sm font-medium text-slate-200">Service end</label>
                <input id="manual-history-service-end" type="date" value={manualHistoryServiceEnd} onChange={(event) => setManualHistoryServiceEnd(event.target.value)} className={COMMON_INPUT_CLASS} />
              </div>
              <div>
                <label htmlFor="manual-history-amount" className="block text-sm font-medium text-slate-200">Total bill amount</label>
                <input id="manual-history-amount" type="number" min="0" step="0.01" value={manualHistoryAmount} onChange={(event) => setManualHistoryAmount(event.target.value)} placeholder="164.22" className={COMMON_INPUT_CLASS} />
              </div>
              <div>
                <label htmlFor="manual-history-usage" className="block text-sm font-medium text-slate-200">Usage (kWh)</label>
                <input id="manual-history-usage" type="number" min="0" step="0.01" value={manualHistoryUsage} onChange={(event) => setManualHistoryUsage(event.target.value)} placeholder="921" className={COMMON_INPUT_CLASS} />
              </div>
              <div className="md:col-span-2">
                <label htmlFor="manual-history-rate-plan" className="block text-sm font-medium text-slate-200">Rate plan (optional)</label>
                <input id="manual-history-rate-plan" value={manualHistoryRatePlan} onChange={(event) => setManualHistoryRatePlan(event.target.value)} placeholder="Residential" className={COMMON_INPUT_CLASS} />
              </div>
            </div>
